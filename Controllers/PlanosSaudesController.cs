...
{
    public class PlanosSaudesController : Controller
    {
        private readonly ApplicationDbContext _context;

        public PlanosSaudesController(ApplicationDbContext context)
        {
            _context = context;    
        }
        ...
        {
            return View(await _context.PlanoSaude.ToListAsync());
        }

        // GET: PlanoSaudes/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var planoSaude = await _context.PlanoSaude.SingleOrDefaultAsync(m => m.ID == id);
            if (planoSaude == null)
            {
                return NotFound();
            }
        ...
        // GET: PlanoSaudes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PlanoSaudes/Create
        ...
        {
            return _context.PlanoSaude.Any(e => e.ID == id);
        }
    }
}
