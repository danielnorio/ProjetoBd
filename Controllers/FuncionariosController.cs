...
namespace ProjetoDeBancoDeDados.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,CPF,Cargo,Email,Nome,RG,Telefone")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,CPF,Cargo,Email,Nome,RG,Telefone")] Funcionario funcionario)
        {
